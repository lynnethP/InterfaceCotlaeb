...
var cant_pwhii_uno = 7;
var cant_pwhii_dos = 10;
var cant_pwhii_tres = 8;
...
/*var seleccion = document.querySelector('input[name="turno"]:checked').value;*/
		    ...
		    if(!document.querySelector('input[name="turno"]:checked')) {
		      ...
		      } else if ((document.querySelector('input[name="turno"]:checked').value == "diurno" && cant_pwhii_uno >= 10) || 
		      	(document.querySelector('input[name="turno"]:checked').value == "nocturno" && cant_pwhii_dos >= 10) || 
		      	(document.querySelector('input[name="turno"]:checked').value == "sabatino" && cant_pwhii_tres >= 10)) {
			      	...
			      	alert("Tu docente es: Ing. Gloria Castillo. Tu sección es: PWHII-01. Tu horario es: Diurno");

		      }else if (document.querySelector('input[name="turno"]:checked').value == "nocturno" ) {

			      	alert("Gracias por inscribirte en nuestros cursos");
			      	alert("Tu docente es: Ing. Sol Hernández. Tu sección es: PWHII-02. Tu horario es: Nocturno");
		      }else if (document.querySelector('input[name="turno"]:checked').value == "sabatino" ) {

			      	alert("Gracias por inscribirte en nuestros cursos");
			      	alert("Tu docente es: Ing. Ligia Durán. Tu sección es: PWHII-03. Tu horario es: Sabatino");
